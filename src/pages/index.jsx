...
function Home() {
  return (
    <div>
      {/* CATEGORIES */}
      <section>
        <div className="row no-gutters d-lg-flex flickity flickity-lg-none">
          {/* Item */}
          <div className="col-12 col-md-6 col-lg-4 d-flex flex-column bg-cover" style={{backgroundImage: 'url(/img/covers/cover-1.jpg)'}}>
            <div className="card bg-dark-5 bg-hover text-white text-center" style={{minHeight: '470px'}}>
              ...
              <div className="card-body mt-auto py-8">
                {/* Button */}
                <Link className="btn btn-white stretched-link" to={path.Product}>
            ...
            <div className="col-12 col-md-5 col-lg-4 d-flex flex-column">
              ...
              <div className="card mb-7 text-white" style={{minHeight: '400px', backgroundImage: 'url(/img/products/product-1.jpg)'}}>
                ...
                <div className="card-body my-auto text-center">
                  ...
                  {/* Link */}
                  <Link className="btn btn-link stretched-link text-reset" to={path.Product}>
            ...
            <div className="col-12 col-md-7 col-lg-8 d-flex flex-column">
              ...
              <div className="card mb-7 text-body" style={{minHeight: '400px'}}>
                ...
                <div className="card-body my-auto px-md-10 text-center text-md-left">
                  ...
                  {/* Link */}
                  <Link className="btn btn-link stretched-link px-0 text-reset" to={path.Product}>
                    Shop Now <i className="fe fe-arrow-right ml-2" />
                  </Link>
                </div>
              </div>
                  ...
                  <div className="card mb-7">
                    ...
                    <div className="card-body px-0">
                      ...
                      <div className="font-size-xs">
                        <Link className="text-muted" to={path.Product}>Shoes</Link>
                      </div>
                      {/* Title */}
                ...
                <div className="col-6 col-md-4 col-lg-3">
                  ...
                  <div className="card mb-7">
                    ...
                    <div className="card-body px-0">
                      {/* Category */}
                      <div className="font-size-xs">
                        <Link className="text-muted" to={path.Product}>Dresses</Link>
                      </div>
                      {/* Title */}
                      <div className="font-weight-bold">
                        <a className="text-body" href="product.html">
                ...
                <div className="col-6 col-md-4 col-lg-3">
                  ...
                  <div className="card mb-7">
                    ...
                    <div className="card-body px-0">
                      {/* Category */}
                      <div className="font-size-xs">
                        <Link className="text-muted" to={path.Product}>Tops</Link>
                      </div>
                      {/* Title */}
                      <div className="font-weight-bold">
                        <a className="text-body" href="product.html">
                ...
                <div className="col-6 col-md-4 col-lg-3">
                  ...
                  <div className="card mb-7">
                    ...
                    <div className="card-body px-0">
                      {/* Category */}
                      <div className="font-size-xs">
                        <Link className="text-muted" to={path.Product}>Bags</Link>
                      </div>
                      {/* Title */}
                      <div className="font-weight-bold">
                        <a className="text-body" href="product.html">
                ...
                <div className="col-6 col-md-4 col-lg-3">
                  ...
                  <div className="card mb-7">
                    ...
                    <div className="card-body px-0">
                      {/* Category */}
                      <div className="font-size-xs">
                        <Link className="text-muted" to={path.Product}>Skirts</Link>
                      </div>
                      {/* Title */}
                      <div className="font-weight-bold">
                        <a className="text-body" href="product.html">
                    ...
                    <div className="card-body">
                      ...
                      <div className="row align-items-center mb-6">
                        ...
                        <div className="col-8 ml-n2">
                          {/* Preheading */}
                          <Link className="font-size-xs text-muted" to={path.Product}>
                            Shoes
                          </Link>
                          {/* Heading */}
