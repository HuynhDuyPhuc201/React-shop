          ...
          <div className="row">
            ...
            <div className="col-6 col-sm">
              ...
              <ul className="list-unstyled mb-7 mb-sm-0">
                ...
                <li>
                  <Link className="text-gray-300" data-toggle="modal" to="#modalSizeChart">Size Guide</Link>
                </li>
                <li>
                  <Link className="text-gray-300" to={'/'}>Shipping &amp; Returns</Link>
                </li>
              </ul>
            </div>
            <div className="col-6 col-sm">
              ...
              <ul className="list-unstyled mb-7 mb-sm-0">
                <li>
                  <Link className="text-gray-300" to={path.Product}>Men's Shopping</Link>
                </li>
                <li>
                  <Link className="text-gray-300" to={path.Product}>Women's Shopping</Link>
                </li>
                <li>
                  <Link className="text-gray-300" to={path.Product}>Kids' Shopping</Link>
                </li>
                <li>
                  <Link className="text-gray-300" to={path.Product}>Discounts</Link>
                </li>
              </ul>
            </div>
            <div className="col-6 col-sm">
